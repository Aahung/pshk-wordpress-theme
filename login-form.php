...
*/
?>
<div class="callout widget" id="theme-my-login<?php $template->the_instance(); ?>">
    ...
    <form name="loginform" id="loginform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'login', 'login_post' ); ?>" method="post">
        <div class="row">
            ...
            <div class="large-12 columns">
                <label for="user_pass<?php $template->the_instance(); ?>"><?php _e( 'Password', 'theme-my-login' ); ?>
            ...
            <div class="large-12 columns">
                <input class="button" type="submit" name="wp-submit" id="wp-submit<?php $template->the_instance(); ?>" value="<?php esc_attr_e( 'Log In', 'theme-my-login' ); ?>" />
